...
// Filter filters the iterable by applying the given function to each item, returning only the items for which the function returns true.
...
// Reduce applies the given function cumulatively to the items of the slice, from left to right, to reduce the slice to a single value.
